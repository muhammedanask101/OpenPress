...
const UserRegister = () => {
    ...
    const onSubmit = e => {
     ...
     return (
        ...
        <>
        <h1 className='text-3xl md:text-5xl font-bold text-blue-100 mb-15 p-2 mt-2 text-center text-shadow-md text-shadow-black'>User Register</h1>
        <section className="flex justify-center p-6">
            <form onSubmit={onSubmit} className="shadow-md shadow-black rounded-lg p-6 w-full max-w-md space-y-4">
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <div>
                        <input className="mt-1 block w-full rounded-md border border-gray-300 shadow-sm p-2 focus:border-sky-500 focus:ring focus:ring-sky-200 focus:ring-opacity-50" type='password' id='password2' name='password2' value={password2} onChange={onChange} />
                    </div>
                </div>
